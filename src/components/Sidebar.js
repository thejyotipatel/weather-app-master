...
const Sidebar = () => {
  const { weatherData, setDate, getCurrentLocation } = useAppContext()
    ...
    <>
      ...
      >
        ...
        <img
          src={img}
          style={{ opacity: '10%' }}
          className='bg-no-repeat mt-[15px] mx-auto   max-h-[400px]  '
        />
        {weatherData.consolidated_weather !== undefined && (
          <>
            <img
              ...
              // src={Hail}
              alt='weather images'
              className=' mx-auto -mt-[130px] md:-mt-[130px] w-[20%] max-w-[50vw] '
            />
